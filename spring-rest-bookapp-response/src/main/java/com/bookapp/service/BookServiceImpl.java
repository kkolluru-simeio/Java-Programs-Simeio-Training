...
public class BookServiceImpl implements IBookService {
	...
	@Override
	public List<Book> getByTitleContaining(String category, String title) throws BookNotFoundException{
		List<Book> books = bookRepository.findByTitleContaining(category, title);
		if (books.isEmpty())
