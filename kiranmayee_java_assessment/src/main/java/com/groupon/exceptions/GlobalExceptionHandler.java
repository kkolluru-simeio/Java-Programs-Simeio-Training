package com.groupon.exceptions;
...
import com.groupon.model.ApiErrors;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<Object> handleDealNotFound(DealNotFoundException ex) {
		String message = ex.getMessage();
		List<Object> error = Arrays.asList("deal not found", ex.getMessage());
		HttpHeaders httpHeaders = new HttpHeaders();
		httpHeaders.add("info", "deal not found");
	...
	public ResponseEntity<Object> handleUserNotFound(UserNotFoundException ex) {
		String message = ex.getMessage();
		List<Object> error = Arrays.asList("user not found", ex.getMessage());
		HttpHeaders httpHeaders = new HttpHeaders();
	...
	public ResponseEntity<Object> handleLogNotFound(LogNotFoundException ex) {
		String message = ex.getMessage();
		List<Object> error = Arrays.asList("log not found", ex.getMessage());
		HttpHeaders httpHeaders = new HttpHeaders();
		httpHeaders.add("info", "log not found");
		ApiErrors errors = new ApiErrors(LocalDateTime.now(), message, HttpStatus.INTERNAL_SERVER_ERROR, HttpStatus.INTERNAL_SERVER_ERROR.value(), error);
		return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).headers(httpHeaders).body(errors);
	}
	
	@ExceptionHandler(IncorrectUserDetailsException.class)
	public ResponseEntity<Object> handleIncorrectUserDetailsException(IncorrectUserDetailsException ex) {
		String message = ex.getMessage();
		List<Object> error = Arrays.asList("incorect user details", ex.getMessage());
		HttpHeaders httpHeaders = new HttpHeaders();
		httpHeaders.add("info", "incorrect user details");
		ApiErrors errors = new ApiErrors(LocalDateTime.now(), message, HttpStatus.INTERNAL_SERVER_ERROR, HttpStatus.INTERNAL_SERVER_ERROR.value(), error);
		return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).headers(httpHeaders).body(errors);
	}
	...
	public ResponseEntity<Object> handleException(Exception ex) {
		String message = ex.getMessage();
		List<Object> error = Arrays.asList("other exception", ex.getStackTrace());
		HttpHeaders httpHeaders = new HttpHeaders();
